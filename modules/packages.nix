...

{
  ...
  environment.systemPackages = with pkgs; [
    ...
    kdePackages.kdenlive        # KDE Non-Linear Video Editor
  ...
  # -------------------------------------------------------------------------
  # Delete this entire block if it conflicts with rebuilds
  # Note: This might only conflict if the windows-fonts folder is not available
 fonts.packages = lib.optionals (builtins.pathExists ../windows-fonts) [
